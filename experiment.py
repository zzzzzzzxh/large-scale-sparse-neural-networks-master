...
if __name__ == '__main__':
    ...
    for eps in range(len(epsilon_set)):
        model_config['epsilon'] = epsilon_set[eps]
        ...
        # 保存结果
        save_dic('result/cifar10_relu_' + str(n_epochs) + 'epoch_epsilon_' + str(epsilon_set[eps]) + '.txt', results)

...
if __name__ == '__main__':
    ...
    Lrelu_res = read_dic('result/cifar10_Lrelu_0.75_500epoch_epsilon20.txt')
    relu_res = read_dic('result/cifar10_relu_500epoch_epsilon20.txt')
    allrelu_res = read_dic('result/cifar10_allrelu_0.75_500epoch_epsilon20.txt')
    grelu_res = read_dic('result/cifar10_grelu_0.75_500epoch_epsilon20.txt')
    ...
    # PlotActiFunc(x, Lrelu_acc, title='acc')
    ...
    plt.title('Performance on CIFAR10')
    #设置y轴
    # plt.ylim([50, 90])
    plt.figure(1)
    plt.show()
    ...
    plt.title('Effective Gradient Flow on CIFAR10')
    # plt.ylim([50, 90])
    plt.figure(2)
    plt.show()
    ...
    plt.title('Overfitting on CIFAR10')
    # plt.ylim([50, 90])
    plt.figure(3)
    plt.show()

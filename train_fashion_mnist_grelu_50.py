...
if __name__ == '__main__':
    ...
    parser.add_argument('--epsilon', type=int, default=50, help='Sparsity level (default: 20)')
    ...
    #保存结果
    save_dic('result/FasionMNIST_grelu_0.6_500epoch_epsilon50_new.txt', results)
    #读取结果

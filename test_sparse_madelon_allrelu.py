...
if __name__ == '__main__':
    ...
    save_dic('dense_results/madalon_allrelu_0.1_500epoch_dense_3.txt', results)
    #保存结果
    save_dic('sparse_level_result/madalon_allrelu_0.5_500epoch_epsilon40_3.txt', results)

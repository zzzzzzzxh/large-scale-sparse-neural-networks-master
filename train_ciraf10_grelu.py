...
if __name__ == '__main__':
    ...
    if args.dataset == 'fashionmnist' or args.dataset == 'mnist':
        ...
        # activations = (AlternatedLeftReLU(-0.25), AlternatedLeftReLU(0.25), AlternatedLeftReLU(-0.25), Softmax)
    ...
    #保存结果
    save_dic('result/cifar10_grelu_0.75_500epoch_epsilon20_2.txt', results)
    #读取结果
